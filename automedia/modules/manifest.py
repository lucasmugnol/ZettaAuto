        ...
        **kwargs
        ...
        if manifest_data is None:
            ...
            manifest_data = {
                ...
                "cover_selection_identity": _serialize(kwargs.get("cover_selection_identity")),
                "cover_transformation_provenance": _serialize(kwargs.get("cover_transformation_provenance")),
                "composer_integrity_verification": _serialize(kwargs.get("composer_integrity_verification")),
